    ...
    <div class="flex flex-col dark:bg-surface-dp6 p-4 rounded shadow-md">
        <div class="flex justify-between">
            <h1 v-if="!editingHeading"
                class="text-2xl font-semibold text-justify rounded shadow-lg dark:bg-surface-dp8 p-2">
            ...
            <button v-if="!editingHeading" class="bg-surface-dp24 hover:brightness-125 p-2 rounded-md"
            ...
            <div v-for="answer, index in props.question!.answers" class="dark:bg-surface-dp8">
                <div class="flex justify-between">
                    ...
                    <div v-if="!editingAnswer && editingIndex < 0" class="flex gap-4">
                        ...
                        <button class="bg-surface-dp24 hover:bg-error p-2 rounded-md" @click="props.question.answers.splice(index, 1); saveQuestion()">
